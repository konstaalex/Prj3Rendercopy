...
import {JWTAuthenticationStrategy, JWTService, MyUserService, RefreshtokenService, SecuritySpecEnhancer} from './services';
import {registerAuthenticationStrategy} from './types';
...
export class JWTAuthenticationComponent implements Component {
  bindings: Binding[] = [
    ...
    Binding.bind(UserServiceBindings.USER_REPOSITORY).toClass(MyUserRepository),
